...
//#define GMFN extern "C" __fastcall(dllexport)
...
gm::GMVARIABLE *mVectorResultX;
gm::GMVARIABLE *mVectorResultY;
gm::GMVARIABLE *mVectorResultZ;
gm::GMVARIABLE *mQuaternionResultW;
gm::GMVARIABLE *mQuaternionResultX;
gm::GMVARIABLE *mQuaternionResultY;
gm::GMVARIABLE *mQuaternionResultZ;
