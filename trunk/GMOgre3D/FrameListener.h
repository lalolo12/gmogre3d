...
/*
      Ogre::String debug_txt;
      debug_txt = "Pitch: " + Ogre::StringConverter::toString(mCamera->pitch()) + ",  Yaw: " + Ogre::StringConverter::toString(mCamera->yaw());
      Ogre::OverlayElement* guiDbg = Ogre::OverlayManager::getSingleton().getOverlayElement("Core/DebugText");
      guiDbg->setCaption(debug_txt);
*/
   }
